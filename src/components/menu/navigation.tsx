    ...
    return (
      <Navbar onMenuOpenChange={setIsMenuOpen}>
        <NavbarContent>
          ...
          />
          <NavbarBrand>
            <p className="font-bold text-2xl text-white">nycom</p>
          </NavbarBrand>
        </NavbarContent>
        ...
        <NavbarContent justify="end">
          <NavbarItem>
            <NavLink className="bg-white hover:bg-green-700 hover:text-white duration-700 rounded-md text-black py-[5px] px-4 font-medium" to="login"  >
              Login
            </NavLink>
          </NavbarItem>
        </NavbarContent>
